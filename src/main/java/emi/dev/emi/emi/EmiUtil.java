...
public class EmiUtil {
	...
	public static String subId(Block block) {
		return "block/" + subId(new NumericIdentifier(block.blockID));
	}
	
	public static String subId(Item item) {
		return "item/" + subId(new NumericIdentifier(item.itemID));
	}
	...
	public static InventoryCrafting getCraftingInventory() {
		return new InventoryCrafting(new Container(minecraft.thePlayer) {
