...
import emi.dev.emi.emi.config.SidebarSubpanels;
import emi.dev.emi.emi.config.SidebarType;
import emi.dev.emi.emi.screen.ConfigScreen.Mutator;
...
import emi.shims.java.net.minecraft.client.gui.widget.ClickableWidget;
	...
	public List<TooltipComponent> getTooltip(int mouseX, int mouseY) {
		for (IntEdit edit : rows) {
			if (edit.contains(mouseX, mouseY)) {
				return List.of(TooltipComponent.of(EmiPort.ordered(EmiPort.translatable("emi.sidebar.size.rows"))));
			}
		}
