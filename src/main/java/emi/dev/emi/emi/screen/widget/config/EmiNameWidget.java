...
import emi.shims.java.net.minecraft.text.Style;
...
public class EmiNameWidget implements Drawable {
	...
	private List<String[]> NAMES =
			Lists.<String[]>newArrayList("Emi Memy Imi".split(" "), "Exhaustively Many Ingredients".split(" "), "Explicitly Mandated Items".split(" "),
					...
					"Exploring Modified: Iridescent".split(" "), "E M I".split(" "), "Eager Madi1718 Illness".split(" "));
	public int x, y;
	...
	public String interpolate(Random source, String first, String second, float progress) {
		FontRenderer render = client.fontRenderer;
