...
//		register.accept(new EmiRemoveFromIndex());
	 ...
	 *
	 * @param id Resource location for recipe. Generally uses {@link emi.shims.java.net.minecraft.util.SyntheticIdentifier}
	 */
