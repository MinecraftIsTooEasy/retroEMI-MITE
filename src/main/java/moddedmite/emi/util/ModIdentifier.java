...
public class ModIdentifier {
    ...
    private static boolean isMITEBlock(int id) {
        if (id >= 198 && id < 256 || id == 95) return true;
        return id >= 164 && id < 170;
    }

    private static boolean isMinecraftBlock(int id) {
        if (id >= 170 && id <= 174) return true;
        return id <= 163;
    }

    private static boolean isMITEItem(int id) {
        if (id > 955 && id < 1283) {
            if (!(id >= 1058 && id <= 1066)) return true;
            if (!(id >= 1135 && id <= 1141)) return true;
            if (!(id >= 1168 && id <= 1171)) return true;
            if (!(id >= 1265 && id <= 1275)) return true;
            if (id != 1116 && id != 1026 && id != 1027) return true;
        }
    ...
    private static boolean isMinecraftItem(int id) {
        if (id > 256 && id <= 422) {
            if (!(id > 269 && id < 280)) return true;
            if (!(id > 309 && id < 314)) return true;
            if (!(id > 408 && id < 417)) return true;
            if (id != 262 && id != 268 && id != 290 && id != 291 && id != 293 && id != 419) return true;
        }
